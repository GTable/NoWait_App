...
export const Images = {
  ...
  "onboard-1": require("./images/onboard/onboard_1.png"),
  "onboard-2": require("./images/onboard/onboard_2.png"),
  "onboard-3": require("./images/onboard/onboard_3.png"),
  "kakao-logo": require("./images/onboard/kakao-logo.png"),
};

export const SvgIcons = {
  "bottom-tab-home-active": BottomTabHomeActive,
  "bottom-tab-home-inactive": BottomTabHomeInactive,
  "bottom-tab-search-active": BottomTabSearchActive,
  "bottom-tab-search-inactive": BottomTabSearchInactive,
  "bottom-tab-map-active": BottomTabMapActive,
  "bottom-tab-map-inactive": BottomTabMapInactive,
  "bottom-tab-mypage-active": BottomTabMyPageActive,
  "bottom-tab-mypage-inactive": BottomTabMyPageInactive,
};

export { CheckSvg } from "./images/ui/check/CheckSvg";
export { ArrowLeftSvg } from "./images/ui/arrow/ArrowLeftSvg";
